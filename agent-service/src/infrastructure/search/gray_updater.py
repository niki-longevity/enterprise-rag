...
from src.infrastructure.search.splitter import split_document_by_markdown_sections
from src.infrastructure.search.chroma import (
    insert_chunks as chroma_insert,
    delete_chunks_by_file as chroma_delete,
)
from src.infrastructure.storage.minio import download_file
from src.infrastructure.search.elastic_index import (
...
def init_policies():
    ...
    from src.infrastructure.search.loader import load_policy_documents
    from src.infrastructure.search.chroma import clear as chroma_clear
    from src.infrastructure.search.elastic_index import create_index
